import { ArrowRight, BookOpen, Check, Pencil, Play } from 'lucide-react'
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8 pb-12">
      ...
      >
        ...
        <h2 className="relative font-display mt-3 text-3xl font-bold leading-tight md:text-4xl">Maîtrisez l&apos;examen TEF</h2>
        <p className="relative mt-4 max-w-xl text-sm leading-relaxed text-slate-200">
          Complete specialized modules designed for the Chamber of Commerce standards. High-fidelity simulations with exam-locked
          conditions — listening & speaking combined.
        </p>
        <Link
          to="/tef-prep"
      ...
      <p className="text-center text-xs text-slate-500">
        ...
        Footer stats are shared across the TEF atelier (local device). ElevenLabs + OpenAI keys live on the API server.
      </p>
    </div>
  )
}
