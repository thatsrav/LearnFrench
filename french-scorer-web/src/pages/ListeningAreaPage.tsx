...
export default function ListeningAreaPage() {
  return (
    <div className="mx-auto max-w-3xl space-y-8 text-center">
      <div className="rounded-3xl border border-slate-100 bg-white p-10 shadow-sm">
        ...
        <h1 className="font-display mt-6 text-2xl font-bold text-[#1e293b]">Listening Area</h1>
        <p className="mx-auto mt-3 max-w-md text-sm text-slate-600">
          TEF-style listening labs, no-rewind drills, and comprehension checks live in the TEF Prep track.
        </p>
        <Link
          to="/tef-prep/a1/1/listening"
